<%@ Page Title="" Language="C#" MasterPageFile="~/master_pages/admin.Master" AutoEventWireup="true" CodeBehind="list_volunteer.aspx.cs" Inherits="HHO_NGO.web_pages.admin.list_volunteer" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
        <div class="title">List of Volunteers</div>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" FilterExpression="user_name like '%{0}%'" SelectCommand="SELECT * FROM [user_details] WHERE ([user_type] = @user_type)" DeleteCommand="DELETE FROM user_details where user_id = @user_id" UpdateCommand="UPDATE user_details SET status = 'Approve' WHERE (user_id = @user_id)">
                <SelectParameters>
            ...
            <asp:GridView ID="gv_donor" runat="server" CssClass="grid_view" ShowHeaderWhenEmpty="True" EmptyDataText="No Records Found!!!" Height="100%" Width="100%" AllowPaging="True" AutoGenerateColumns="False" CellPadding="3" DataKeyNames="user_id" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" DataSourceID="SqlDataSource1">
                <Columns>
                    ...
                    <asp:ButtonField ButtonType="Button" CommandName="Update" HeaderText="Approve" Text="Approve">
