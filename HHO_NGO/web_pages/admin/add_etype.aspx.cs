...
{
    public partial class add_etype : System.Web.UI.Page
    {
        ...
        {
            insertsql = "insert into event_type values('" + txttype_name.Text + "','" + txtdesc.Text + "')";
            ...
            try
            {
                con.Open();
                cmd.ExecuteNonQuery();
                Response.Redirect("~/web_pages/admin/event_type.aspx");
            }
            catch (Exception ex)
            {
