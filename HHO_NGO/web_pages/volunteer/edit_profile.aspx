<%@ Page Title="" Language="C#" MasterPageFile="~/master_pages/volunteer.Master" AutoEventWireup="true" CodeBehind="edit_profile.aspx.cs" Inherits="HHO_NGO.web_pages.volunteer.edit_profile" %>
    ...
    <div class="container">
        <div class="title">Edit Profile</div>
            ...
            <span>Don't want to update your profile!
                <asp:HyperLink ID="login_link" CssClass="login_link" NavigateUrl="~/web_pages/volunteer/profile.aspx" runat="server">Go Back</asp:HyperLink>
            </span><br />
        </div>
    </div>
</asp:Content>
